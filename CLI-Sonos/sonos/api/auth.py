...
from sonos.settings import SONOS_CLIENT_ID, SONOS_CLIENT_SECRET, CLIENT_REDIRECT_URL, AUTH_URL, ACCESS_TOKEN_URL, \
    CLIENT_SCOPE

client = OAuth2Session(SONOS_CLIENT_ID, redirect_uri=CLIENT_REDIRECT_URL, scope=CLIENT_SCOPE)
